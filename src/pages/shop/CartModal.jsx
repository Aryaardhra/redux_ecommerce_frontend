...
const CartModal = ({ products, isOpen, onClose }) => {
  ...
  return (
    ...
    >
        <div className={`fixed right-0 top-0 md:w-1/3 w-full bg-neutral-100 h-full overflow-auto
            ...
            >
             <div className="p-4 mt-4">
                ...
                <button 
                onClick={()=> onClose()}
                className="text-gray-600 hover:text-gray-900"><i className="ri-close-circle-line bg-black p-1 text-white"></i>
                </button>
                </div>
